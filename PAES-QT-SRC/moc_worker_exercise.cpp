/****************************************************************************
** Meta object code from reading C++ file 'worker_exercise.h'
**
...
#error "The header file 'worker_exercise.h' doesn't include <QObject>."
...
void Worker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &Worker::error; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
