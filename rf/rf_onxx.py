            ...
            try:
                ...
                if len(data_str) == 0:
                    ...
                    try:
                        ...
                        if data_str =="EXIT":
                            self.client_dscn.sendall("EXIT".encode(FORMAT))  
                        ...
                        #prediction mmove same current move and ,current move is done 
                            ...
                            if ( top_3_predictions[0]!=current_class):
                                ...
                                if (new_move["name"]==top_3_predictions[0] and new_move["time"]>move_times[new_move["name"]]/2 ):
                                    ...
                                    if  current_class!="walk":
                                        self.client_dscn.sendall(f"{current_class} {current_probability:.4f} new_move {move_repetitions[current_class]}".encode(FORMAT))  
